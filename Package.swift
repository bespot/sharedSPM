...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/spvagelis/papertrail-lumberjack-ios.git", exact: "2.1.4")
    ],
    targets: [
        ...
        .binaryTarget(name: "shared",
                      url: "https://github.com/bespot/sharedSPM/releases/download/1.0.8/shared.xcframework.zip",
